        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '9f27bb4a-a767-45a3-8489-e8eecfecd3fd',
                name: data.name || '',
                email: data.email || '',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בני מכבי אינסטלטור משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
